...
public class DeleteQuestion extends JFrame {
    ...
    private Container c;
    private JButton deletebutton, clearbutton,closebutton,searchbutton;
    private JLabel background, label1, label2,qnolabel, qlabel, opt1label, opt2label, opt3label, opt4label, anslabel;
    private Font f1, f2;
    ...
    private void initComponents() {
        ...
        this.setTitle("Delete Question Page");
...
//Frame in Container c
        ...
        //Inserting Images
        updateimg = new ImageIcon(getClass().getResource("/img/delete Question.png"));
        ...
        label2 = new JLabel("Delete Questions");
    ...
    //Question NO
       ...
       searchbutton.setFont(f1);
        ...
        deletebutton.setIcon(saveimg);
        deletebutton.setBounds(250,460,130,30);
        c.add(deletebutton);
